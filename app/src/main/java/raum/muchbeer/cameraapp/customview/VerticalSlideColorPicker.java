...
public class VerticalSlideColorPicker extends View {
    ...
    public VerticalSlideColorPicker(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public VerticalSlideColorPicker(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public VerticalSlideColorPicker(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
